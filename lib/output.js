...
function minify(output, fileName, mangle, globalDefs, ascii, unused) {
...
exports.writeOutputs = function(outputs, baseURL, outputOpts) {
  ...
  if (outputOpts.minify)
    output = minify(output, fileName, outputOpts.mangle, outputOpts.globalDefs, outputOpts.ascii, outputOpts.unused);
