...
Trace.prototype.getLoadRecord = function(canonical, excludeURLs, parentStack) {
  ...
  var defaultJSExtension = loader.defaultJSExtensions && canonical.substr(canonical.length - 3, 3) != '.js';
  ...
  .then(function(normalized) {
    ...
    if (pkgEnvIndex != -1) {
      ...
      defaultJSExtension = loader.defaultJSExtensions && pkgName.substr(pkgName.length - 3, 3) != '.js';
      var normalizedPkgName = loader.decanonicalize(pkgName);
      if (defaultJSExtension && normalizedPkgName.substr(normalizedPkgName.length - 3, 3) == '.js')
        normalizedPkgName = normalizedPkgName.substr(0, normalizedPkgName.length - 3);
          ...
          return Promise.all(Object.keys(envMap).map(function(envCondition) {
            ...
            .then(function() {
              if (mapping == '.')
                ...
                return loader.normalize(mapping, normalizedPkgName);
            })
