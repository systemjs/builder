...
Trace.prototype.traceModule = function(moduleName, traceOpts) {
  ...
  .then(function(canonicalConditionalEnv) {
    if (!traceOpts.traceConditionsOnly)
      return self.getAllLoadRecords(moduleName, traceOpts.excludeExternals, traceOpts.tracePackageConfig, traceOpts.traceAllConditionals, canonicalConditionalEnv, {}, []);
    else
      return self.getConditionLoadRecords(moduleName, traceOpts.excludeExternals, traceOpts.tracePackageConfig, canonicalConditionalEnv, false, {}, []);
  })
  .then(function(loads) {
...
Trace.prototype.getLoadRecord = function(canonical, excludeExternals, parentStack) {
  var loader = this.loader;
...
Trace.prototype.getAllLoadRecords = function(canonical, excludeExternals, tracePackageConfig, traceAllConditionals, canonicalConditionalEnv, curLoads, parentStack) {
  var loader = this.loader;
  ...
  var self = this;
  return this.getLoadRecord(canonical, excludeExternals, parentStack)
  .then(function(load) {
    ...
    if (load) {
      ...
      return Promise.all(Trace.getLoadDependencies(load, tracePackageConfig, true, traceAllConditionals, canonicalConditionalEnv).map(function(dep) {
        return self.getAllLoadRecords(dep, excludeExternals, tracePackageConfig, traceAllConditionals, canonicalConditionalEnv, curLoads, parentStack);
      }));
    }
  })
  .then(function() {
...
Trace.prototype.getConditionLoadRecords = function(canonical, excludeExternals, tracePackageConfig, canonicalConditionalEnv, inConditionTree, curLoads, parentStack) {
  var loader = this.loader;
  ...
  .then(function(load) {
    ...
    if (load) {
      ...
      return Promise.all(Trace.getLoadDependencies(load, tracePackageConfig, true, true, canonicalConditionalEnv, true).map(function(dep) {
        return self.getConditionLoadRecords(dep, excludeExternals, tracePackageConfig, canonicalConditionalEnv, true, curLoads, parentStack);
      }))
      .then(function() {
        ...
        return Promise.all(Trace.getLoadDependencies(load, tracePackageConfig, true, true, canonicalConditionalEnv).map(function(dep) {
          return self.getConditionLoadRecords(dep, excludeExternals, tracePackageConfig, canonicalConditionalEnv, inConditionTree, curLoads, parentStack);
        }));
      });
    }
  })
