...
Trace.prototype.getLoadRecord = function(canonical, excludeURLs, parentStack) {
  ...
  .then(function(normalized) {
    // this decanonicalize MUST be without extension adding
    if (loader.defaultJSExtensions && canonical.substr(canonical.length - 3, 3) != '.js' && normalized.substr(normalized.length - 3, 3) == '.js')
    ...
    if (pkgEnvIndex != -1) {
      ...
      // NB can remove defaultJSExtensions support here
