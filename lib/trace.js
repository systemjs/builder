...
Trace.prototype.getLoadRecord = function(canonical) {
  ...
  .then(function(normalized) {
    ...
    if (pkgEnvIndex != -1) {
      ...
      var bundleConfig = { packages: {} };
      bundleConfig.packages[pkgName] = {};
      bundleConfig.packages[pkgName].map = {};
      bundleConfig.packages[pkgName].map['./' + subPath] = envMap;
    ...
    var load = {
      ...
      // any config that needs to be inlined with this load record
      config: null,
