  ...
  return expandPromise.then(function() {
    ...
    return expandedOperations.reduce(function(p, op) {
      return p.then(function(curTree) {
        ...
        // tree . tree
        return builder.tracer.traceModule(op.moduleName, traceOpts.tracePackageConfig, traceOpts.traceAllConditionals, traceOpts.conditions, traceOpts.traceConditionsOnly)
