...
function expandGlobAndCanonicalize(builder, operation) {
  ...
  .then(function() {
    if (operation.canonicalized) {
      var defaultJSExtension = loader.defaultJSExtensions && operation.moduleName.substr(operation.moduleName.length - 3, 3) != '.js';
      var normalized = loader.decanonicalize(operation.moduleName);
