...
Builder.prototype.invalidate = function(invalidationModuleName) {
  ...
  // reinstantiate the tracer against the new cache object
...
Builder.prototype.bundle = function(expressionOrTree, outFile, opts) {
  ...
  if (opts) {
    var loaderFetch = self.loader.fetch.bind(self.loader);
    self.fetch = opts.fetch;
    self.loader.fetch = function (load) {
      var source = (self.fetch || loaderFetch).call(self.loader, load, loaderFetch);
