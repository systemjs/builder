...
Builder.prototype.build = function() {
  ...
  return this.buildBundle.apply(this, arguments);
};
...
Builder.prototype.buildTree = function() {
  console.warn('builder.buildTree is deprecated. Using builder.buildBundle instead, which takes both a tree object or expression string.');
  return this.buildBundle.apply(this, arguments);
};
