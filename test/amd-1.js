...
System.register("tree/amd-1", ['./first', './second', 'require', 'module'], false, function(__require, __exports, __module) {
  return (function(first, second, require, module) {
    module.exports = {
      first: first,
      second: require('./second')
    };
  })(__require('./first'), __require('./second'), __require, __require('module'));
});
